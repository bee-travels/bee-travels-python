...
def test_get_currency_name_y_code_for_real():
    ...
    actual = countryCurrencyCodeHandler.get_currency_name_and_code("South Africa")
...
def test_get_single_for_real_currencycode():
    ...
    actual = countryCurrencyCodeHandler.get_country_and_currency_code(currencyCode_)
    assert actual == expected
...
def test_csv_to_dict():
    ...
    actual = countryCurrencyCodeHandler.read_data()
